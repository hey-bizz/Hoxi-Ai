...
import { CheckCircle, Lock, Shield, RefreshCw, ExternalLink, ArrowRight, Copy, Check } from "lucide-react"
  ...
  const steps = [
    {
      ...
      description: "Go to your Cloudflare dashboard",
      action: (
        <Button
          variant="outline"
          size="sm"
    ...
    },
    {
      ...
      description: "Click 'Create Token' → Use 'Read all resources' template",
      action: null,
    },
    {
      number: 3,
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-start">
          ...
          <div className="space-y-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h2 className="text-3xl font-bold text-white">Connect Cloudflare</h2>
                <p className="text-gray-400 text-lg">One-time setup, takes 30 seconds</p>
              </div>
            </div>
            ...
            <Card className="bg-gray-900/40 border-gray-700 backdrop-blur-xl">
              <CardContent className="p-8 space-y-6">
                <div className="text-center space-y-2">
                  ...
                  <p className="text-gray-400 text-sm">Paste your Cloudflare API token below</p>
                </div>
                ...
                <div className="bg-gray-800/50 rounded-lg p-4 space-y-3">
                  <div className="flex items-center justify-between">
                    <span className="text-xs text-gray-400 font-mono">Example token format:</span>
                    <Button
                      variant="ghost"
                      size="sm"
                      onClick={() => copyToClipboard("1234567890abcdef1234567890abcdef12345678")}
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-3 text-sm">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-gray-300">Real-time bot traffic detection</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="w-4 h-4 text-green-400" />
                    <span className="text-gray-300">Bandwidth usage analytics</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="w-4 h-4 text-green-400" />
                    <span className="text-gray-300">Cost optimization insights</span>
                  </div>
                  <div className="flex items-center gap-3">
                    <CheckCircle className="w-4 h-4 text-green-400" />
                    <span className="text-gray-300">Smart blocking recommendations</span>
                  </div>
                </div>
              </CardContent>
            </Card>

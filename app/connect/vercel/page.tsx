        ...
        <div className="max-w-2xl mx-auto">
          ...
          {stage === "intro" && (
            <div className="space-y-6">
              ...
              {/* Upload Alternative */}
              <Card className="bg-gray-900/40 border-gray-700 backdrop-blur-xl mt-6">
                <CardContent className="p-6">
                  ...
                  <p className="text-sm text-gray-300 mb-4">
                    Can't connect via OAuth? Upload your server logs directly and our AI will analyze them for bot
                    detection patterns.
                  </p>
                  <Button

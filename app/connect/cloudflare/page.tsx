        ...
        <div className="max-w-2xl mx-auto">
          ...
          <div className="space-y-6">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-3xl font-bold text-white">Cloudflare Not Yet Supported</h1>
              ...
              <CardContent className="p-8">
                <div className="space-y-6">
                  <div className="text-center space-y-4">
                    ...
                    <div>
                      <h2 className="text-2xl font-bold text-white mb-2">Cloudflare Support Coming Soon</h2>
                      <p className="text-gray-300 mb-4">
                        We are working very hard to get Cloudflare supported with direct API integration.
